...
class Table extends AbstractElement
{
            ...
            for ($i = 0; $i < $rowCount; ++$i) {
                ...
                for ($j = 0; $j < $rowCellCount; ++$j) {
                    ...
                    if ($cellVMerge !== 'continue') {
                        ...
                        $cellCSS = self::getCellStyle($cellStyle);
                        $content .= "<{$cellTag}{$cellColSpanAttr}{$cellRowSpanAttr}{$cellBgColorAttr}{$cellFgColorAttr}{$cellCSS}>" . PHP_EOL;
    ...
    private static function getCellStyle($cellStyle = null){
        $style = '';
